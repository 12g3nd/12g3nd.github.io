    ...
    <PageTransition>
      <section className="section">
        ...
        <div style={{ marginTop: '3rem', maxWidth: '800px' }}>
          {[
            { date: '2026-03-26', title: 'Embracing Brutalist X Y2K Aesthetics in Web Design', abstract: 'Why I chose to abandon Tailwind for this iteration of my portfolio. The importance of structure over polish in a landscape of identical SaaS sites.' },
            { date: '2026-04-29', title: 'My First Year at UofT & Rotman Commerce', abstract: 'Reflections on the intersection of business intelligence and digital product creation, and what traditional finance misses about tech.' },
          ].map((post, i) => (
