    ...
    <PageTransition>
      <section className="section">
        ...
        <div style={{ marginTop: '2rem', display: 'grid', gap: '2rem', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))' }}>
          {[1, 2, 3, 4].map((i) => (
            <div key={i} style={{ backgroundColor: 'var(--bg-surface)', border: '1px solid rgba(253, 246, 227,0.15)', padding: '2rem', transition: 'all 0.15s ease' }} 
              ...
              <p style={{ marginTop: '1rem', fontFamily: 'var(--font-mono)', fontSize: '13px', color: 'rgba(253, 246, 227,0.8)', lineHeight: '1.6' }}>
                Brutalist description of the project and its impact. Connecting business value with clean architecture.
              </p>
              <div style={{ marginTop: '1.5rem', display: 'flex', gap: '0.5rem' }}>
                <span style={{ border: '1px solid rgba(253, 246, 227,0.2)', color: 'rgba(253, 246, 227,0.8)', padding: '0.2rem 0.5rem', fontSize: '12px', fontFamily: 'var(--font-mono)', borderRadius: '999px' }}>React</span>
                <span style={{ border: '1px solid rgba(253, 246, 227,0.2)', color: 'rgba(253, 246, 227,0.8)', padding: '0.2rem 0.5rem', fontSize: '12px', fontFamily: 'var(--font-mono)', borderRadius: '999px' }}>Node.js</span>
              </div>
